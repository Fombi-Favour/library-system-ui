...
{
    public partial class PrintIssue : Form
    {
        public PrintIssue()
        {
        ...
        private void PrintIssue_Load(object sender, EventArgs e)
        {
        ...
        private void PrintIssue_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
